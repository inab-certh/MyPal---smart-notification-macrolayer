...
const presentTime = "2020-07-15T22:42:00Z";
/*void main() async{
  var argpos =await  getDateTime('CLL', 'FN BRNO', DateTime.parse("2020-07-20T19:40:00Z"));
  print(argpos);
}*/
Future<int> getDateTime(String disease, String clinic, DateTime preferredDateTime) async {
  ...
  if (list[0] == null || list[1] == null || list.isEmpty) {
    ...
    if (canYou == false) {
      var intervalCanYou1 = DateTime
          .parse(presentTime)
          .minute + 2; //plus 2 minutes for now
      print('The notification will be issued now at ' + DateTime
          .parse(presentTime)
          .hour
          .toString() + ':' + intervalCanYou1.toString());
      return 0;
    } else{
      return preferredDateTime.hour - DateTime.parse(presentTime).hour;
    }
  }
