void main(){
  getPrioritiesForNotificationScheduleNEW(DateTime.parse("2020-05-25 12:00:00"), false, "KI", "CLL", DateTime.parse("2020-05-25 17:00:00"));
}
List getPrioritiesForNotificationScheduleNEW(DateTime date1, bool isChecked1, String clinic, String disease, DateTime prefered) {
 ...
 // String disease = "CLL";
  ...
  //print("opportune time detected at $position:00 and with priority $opp");
  print("");
  print("0: Dont even bother, 1: Better not Bother, 2: Maybe you could, 3: Opportune moment, 4: Preferred moment, 5: Treat as 3 for testing reasons ");
return argpos;
}
